...
public class LRUCacheDemo {
    public static void main(String[] args) {
        ...
        cache.put(3, "Cherry"); // Cache: {1=Apple, 2=Banana, 3=Cherry}
        System.out.println("Cache after adding 3 elements: " + cache);

        System.out.println("\n--- Accessing elements ---");
        System.out.println("Get(2): " + cache.get(2)); // Cache: {1=Apple, 3=Cherry, 2=Banana} (2 becomes MRU)
        System.out.println("Cache after Get(2): " + cache);

        System.out.println("Get(1): " + cache.get(1)); // Cache: {3=Cherry, 2=Banana, 1=Apple} (1 becomes MRU)
        System.out.println("Cache after Get(1): " + cache);

        System.out.println("Get(4) (miss): " + cache.get(4)); // Cache: {3=Cherry, 2=Banana, 1=Apple} (no change)
        System.out.println("Cache after Get(4): " + cache);

        System.out.println("\n--- Adding more elements (triggering eviction) ---");
        cache.put(4, "Date"); // Cache: {2=Banana, 1=Apple, 4=Date} (3 is evicted as it's LRU)
        System.out.println("Cache after Put(4, Date): " + cache);

        cache.put(5, "Elderberry"); // Cache: {1=Apple, 4=Date, 5=Elderberry} (2 is evicted)
        ...
        cache.put(4, "Dragonfruit"); // Cache: {1=Apple, 5=Elderberry, 4=Dragonfruit} (4 becomes MRU, value updated)
